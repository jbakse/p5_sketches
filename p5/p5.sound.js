...
(function(root, factory) {
        ...
        */
        (function(global, exports, perf) {
            ...
            if (window.hasOwnProperty(
                    'webkitOfflineAudioContext') && !window.hasOwnProperty(
                    'OfflineAudioContext')) {
        ...
        if (iOS) {
            ...
            var startIOS = function() {
                if (iosStarted)
                    return;
                // create empty buffer
                var buffer = audiocontext.createBuffer(1, 1,
                    22050);
    ...
    master = function() {
         ...
         */
        p5.prototype.masterVolume = function(vol, rampTime,
            tFromNow) {
            if (typeof vol === 'number') {
                ...
                p5sound.output.gain.cancelScheduledValues(now +
                    tFromNow);
                p5sound.output.gain.linearRampToValueAtTime(
                    currentVol, now + tFromNow);
                p5sound.output.gain.linearRampToValueAtTime(vol,
    ...
    helpers = function() {
            ...
            if (typeof paths === 'string') {
                ...
                if ([
                    ...
                    if (supported) {
                        ...
                        var pathCore = pathSplit[pathSplit.length -
                            1];
                        for (var i = 0; i < p5sound.extensions.length; i++) {
                            var extension = p5sound.extensions[
                                i];
                            var supported = p5.prototype.isFileSupported(
                                extension);
                            if (supported) {
                                ...
                                for (var i = 1; i <= pathSplit.length -
                                    2; i++) {
                                    var p = pathSplit[i];
                                    pathCore += '.' + p;
                                }
         ...
         */
        p5.prototype._mathChain = function(o, math, thisChain,
            nextChain, type) {
    ...
    panner = function() {
        ...
        if (typeof ac.createStereoPanner !== 'undefined') {
            ...
            p5.Panner.prototype.pan = function(val, tFromNow) {
                ...
                this.left.gain.linearRampToValueAtTime(leftVal,
                    t);
            ...
            p5.Panner.prototype.inputChannels = function(
                ...
                if (numChannels === 1) {
                    ...
                    if (typeof(this.splitter === 'undefined')) {
                        this.splitter = ac.createChannelSplitter(
                            2);
                    }
                    this.input.disconnect();
                    this.input.connect(this.splitter);
    ...
    soundfile = function() {
         ...
         * </code></div>
         */
        p5.SoundFile = function(paths, onload, onerror,
            whileLoading) {
            if (typeof paths !== 'undefined') {
                if (typeof paths == 'string' || typeof paths[0] ==
                    'string') {
                    var path = p5.prototype._checkFileFormats(
                        paths);
                    this.url = path;
                } else if (typeof paths == 'object') {
        ...
        p5.prototype.loadSound = function(path, callback, onerror,
            ...
            var s = new p5.SoundFile(path, callback, onerror,
                whileLoading);
            return s;
        };
        /**
        ...
        p5.SoundFile.prototype.load = function(callback,
            ...
            if (this.url != undefined && this.url != '') {
                ...
                request.onerror = function(e) {
                    var err = new CustomError('loadSound',
                        errorTrace, self.url);
                    var msg =
        ...
        p5.SoundFile.prototype._updateProgress = function(evt) {
            if (evt.lengthComputable) {
                var percentComplete = Math.log(evt.loaded / evt
                    .total * 9.9);
         ...
         */
        p5.SoundFile.prototype.play = function(time, rate, amp,
            _cueStart, duration) {
            var self = this;
            var now = p5sound.audiocontext.currentTime;
            var cueStart, cueEnd;
            ...
            if (this.buffer) {
                ...
                if (this.mode === 'restart' && this.buffer &&
                ...
                if (_cueStart) {
                    if (_cueStart >= 0 && _cueStart < this.buffer
                        .duration) {
                ...
                if (duration) {
                    ...
                    duration = duration <= this.buffer.duration -
                        cueStart ? duration : this.buffer.duration;
                } else {
                ...
                if (this._paused) {
                    this.bufferSourceNode.start(time, this.pauseTime,
                        duration);
                    this._counterNode.start(time, this.pauseTime,
                        duration);
                } else {
                    this.bufferSourceNode.start(time, cueStart,
                        duration);
                    this._counterNode.start(time, cueStart,
                        duration);
                }
                this._playing = true;
                this._paused = false;
                ...
                this.bufferSourceNode._arrayIndex = this.bufferSourceNodes
                    .length - 1;
                ...
                var clearOnEnd = function(e) {
                    ...
                    self._onended(self);
                    self.bufferSourceNodes.forEach(function(
                        n, i) {
                        if (n._playing === false) {
                            self.bufferSourceNodes.splice(
                                i);
                        }
                    });
        ...
        p5.SoundFile.prototype.playMode = function(str) {
            ...
            if (s === 'restart' && this.buffer && this.bufferSourceNode) {
                for (var i = 0; i < this.bufferSourceNodes.length -
                    1; i++) {
                    var now = p5sound.audiocontext.currentTime;
        ...
        p5.SoundFile.prototype.isLooping = function() {
            ...
            if (this._looping === true && this.isPlaying() ===
                true) {
                return true;
            }
            return false;
        ...
        p5.SoundFile.prototype.stopAll = function(_time) {
            ...
            if (this.buffer && this.bufferSourceNode) {
                for (var i = 0; i < this.bufferSourceNodes.length; i++) {
                    if (typeof this.bufferSourceNodes[i] !=
                        undefined) {
                        try {
                            this.bufferSourceNodes[i].onended =
                                function() {};
                            this.bufferSourceNodes[i].stop(now +
                                time);
                        } catch (e) {}
         ...
         *                                 t seconds in the future
         */
        p5.SoundFile.prototype.setVolume = function(vol, rampTime,
            tFromNow) {
            if (typeof vol === 'number') {
                var rampTime = rampTime || 0;
                var tFromNow = tFromNow || 0;
                ...
                this.output.gain.linearRampToValueAtTime(
                    currentVol, now + tFromNow);
                this.output.gain.linearRampToValueAtTime(vol,
                    now + tFromNow + rampTime);
            } else if (vol) {
        ...
        p5.SoundFile.prototype.rate = function(playbackRate) {
            if (this.playbackRate === playbackRate && this.bufferSourceNode) {
                if (this.bufferSourceNode.playbackRate.value ===
                    playbackRate) {
                    return;
                }
            }
        ...
        p5.SoundFile.prototype.setPitch = function(num) {
            var newPlaybackRate = midiToFreq(num) / midiToFreq(
                60);
        ...
        p5.SoundFile.prototype.jump = function(cueTime, duration) {
            ...
            var cTime = cueTime || 0;
            var eTime = duration || this.buffer.duration -
                cueTime;
            if (this.isPlaying()) {
                this.stop();
            }
            this.play(0, this.playbackRate, this.output.gain.value,
                cTime, eTime);
        };
        /**
        ...
        p5.SoundFile.prototype.getPeaks = function(length) {
            if (this.buffer) {
                ...
                if (this.buffer) {
                    ...
                    var peaks = new Float32Array(Math.round(
                        length));
        ...
        p5.SoundFile.prototype.reverseBuffer = function() {
            ...
            if (this.buffer) {
                for (var i = 0; i < this.buffer.numberOfChannels; i++) {
                    Array.prototype.reverse.call(this.buffer.getChannelData(
                        i));
                }
                // set reversed flag
        ...
        p5.SoundFile.prototype.setBuffer = function(buf) {
            ...
            var newBuffer = ac.createBuffer(numChannels, size,
                ac.sampleRate);
            if (!buf[0] instanceof Float32Array) {
                buf[0] = new Float32Array(buf[0]);
            }
            for (var channelNum = 0; channelNum < numChannels; channelNum++) {
                var channel = newBuffer.getChannelData(
                    channelNum);
        ...
        p5.SoundFile.prototype._initCounterNode = function() {
            ...
            self._scopeNode = ac.createScriptProcessor(256, 1,
                1);
            // create counter buffer of the same length as self.buffer
            cNode.buffer = _createCounterBuffer(self.buffer);
            cNode.playbackRate.setValueAtTime(self.playbackRate,
                now);
            cNode.connect(self._scopeNode);
            self._scopeNode.connect(p5.soundOut._silentNode);
            self._scopeNode.onaudioprocess = function(
                processEvent) {
                var inputBuffer = processEvent.inputBuffer.getChannelData(
                    0);
                // update the lastPos
                self._lastPos = inputBuffer[inputBuffer.length -
                    1] || 0;
        ...
        var _createCounterBuffer = function(buffer) {
            ...
            var audioBuf = ac.createBuffer(1, buffer.length,
                44100);
        ...
        p5.SoundFile.prototype.processPeaks = function(callback,
            ...
            var offlineContext = new OfflineAudioContext(1,
                bufLen, sampleRate);
            ...
            offlineContext.oncomplete = function(e) {
                ...
                var bufferData = filteredBuffer.getChannelData(
                    0);
                // step 1:
                // create Peak instances, add them to array, with strength and sampleIndex
                do {
                    allPeaks = getPeaksAtThreshold(
                        bufferData, threshold);
                    threshold -= 0.005;
                } while (Object.keys(allPeaks).length <
                    minPeaks && threshold >= minThreshold);
                // step 2:
                ...
                var groups = groupNeighborsByTempo(
                    intervalCounts, filteredBuffer.sampleRate
                );
                // sort top intervals
                var topTempos = groups.sort(function(intA,
                    intB) {
        ...
        function groupNeighborsByTempo(intervalCounts, sampleRate) {
            ...
            intervalCounts.forEach(function(intervalCount, i) {
                try {
                    ...
                    var theoreticalTempo = Math.abs(60 / (
                        intervalCount.interval /
                        sampleRate));
                    theoreticalTempo = mapTempo(
                        theoreticalTempo);
                    var foundTempo = tempoCounts.some(
                        function(tempoCount) {
                            if (tempoCount.tempo ===
                                theoreticalTempo)
        ...
        function getPeaksAtTopTempo(peaksObj, tempo, sampleRate,
            bpmVariance) {
            var peaksAtTopTempo = [];
            var peaksArray = Object.keys(peaksObj).sort();
            ...
            for (var i = 0; i < peaksArray.length; i++) {
                ...
                for (var j = 0; j < peak.intervals.length; j++) {
                    var intervalBPM = Math.round(Math.abs(60 / (
                        peak.intervals[j] / sampleRate)));
                    intervalBPM = mapTempo(intervalBPM);
                    var dif = intervalBPM - tempo;
                    if (Math.abs(intervalBPM - tempo) < bpmVariance) {
                        // convert sampleIndex to seconds
                        peaksAtTopTempo.push(peak.sampleIndex /
                            44100);
                    }
                }
            }
        ...
        function mapTempo(theoreticalTempo) {
            ...
            if (!isFinite(theoreticalTempo) || theoreticalTempo ==
                0) {
                return;
            }
         ...
         *  </code></div>
         */
        p5.SoundFile.prototype.addCue = function(time, callback,
            val) {
        ...
        p5.SoundFile.prototype._onTimeUpdate = function(position) {
            ...
            for (var i = 0; i < cueLength; i++) {
                ...
                var val = cue.val;
                if (this._prevTime < callbackTime &&
    ...
    amplitude = function() {
        ...
        p5.Amplitude = function(smoothing) {
            ...
            this.processor.onaudioprocess = this._audioProcess.bind(
                this);
         ...
         *  </code></div>
         */
        p5.Amplitude.prototype.setInput = function(source,
            smoothing) {
        ...
        p5.Amplitude.prototype.connect = function(unit) {
            if (unit) {
                ...
                this.output.connect(this.panner.connect(p5sound
                    .input));
            }
        };
        ...
        p5.Amplitude.prototype._audioProcess = function(event) {
            for (var channel = 0; channel < event.inputBuffer.numberOfChannels; channel++) {
                var inputBuffer = event.inputBuffer.getChannelData(
                    channel);
                ...
                for (var i = 0; i < bufLength; i++) {
                    x = inputBuffer[i];
                    if (this.normalize) {
                        total += Math.max(Math.min(x / this.volMax,
                            1), -1);
                        sum += Math.max(Math.min(x / this.volMax,
                            1), -1) * Math.max(Math.min(x /
                            this.volMax, 1), -1);
                    } else {
                        total += x;
                        sum += x * x;
            ...
            // normalized value
            this.volNorm = Math.max(Math.min(this.volume / this
                .volMax, 1), 0);
        };
        /**
    ...
    fft = function() {
        ...
        p5.FFT.prototype.waveform = function() {
            ...
            if (mode && !p5.prototype._isSafari()) {
                ...
                for (var i = 0; i < this.timeDomain.length; i++) {
                    var scaled = p5.prototype.map(this.timeDomain[
                        i], 0, 255, -1, 1);
         ...
         *
         */
        p5.FFT.prototype.getEnergy = function(frequency1,
            frequency2) {
            ...
            if (typeof frequency1 !== 'number') {
                ...
                var index = Math.round(frequency1 / nyquist *
                ...
                var lowIndex = Math.round(frequency1 / nyquist *
                    this.freqDomain.length);
                var highIndex = Math.round(frequency2 / nyquist *
                    this.freqDomain.length);
                var total = 0;
        ...
        p5.FFT.prototype.getCentroid = function() {
            ...
            if (centroid_normalization != 0) {
                mean_freq_index = cumulative_sum /
                    centroid_normalization;
            }
            var spec_centroid_freq = mean_freq_index * (nyquist /
                this.freqDomain.length);
    ...
    Tone_core_Tone = function() {
        ...
        if (!isFunction(OscillatorNode.prototype.start)) {
            OscillatorNode.prototype.start = OscillatorNode.prototype
                .noteOn;
        }
        if (!isFunction(OscillatorNode.prototype.stop)) {
            OscillatorNode.prototype.stop = OscillatorNode.prototype
                .noteOff;
        }
        ...
        Tone.prototype.get = function(params) {
            ...
            for (var i = 0; i < params.length; i++) {
                ...
                } else if (Tone.Signal && param instanceof Tone
                    .Signal) {
        ...
        Tone.prototype.toString = function() {
            for (var className in Tone) {
                ...
                if (isFunction(Tone[className]) && isLetter &&
                    sameConstructor) {
                    return className;
                }
            }
        ...
        Tone.prototype.connect = function(unit, outputNum, inputNum) {
            if (Array.isArray(this.output)) {
                ...
                this.output[outputNum].connect(unit, 0,
                    inputNum);
            } else {
        ...
        Tone.prototype.defaultArg = function(given, fallback) {
            if (this.isObject(given) && this.isObject(fallback)) {
                ...
                for (var givenProp in given) {
                    ret[givenProp] = this.defaultArg(fallback[
                        givenProp], given[givenProp]);
                }
                for (var fallbackProp in fallback) {
                    ret[fallbackProp] = this.defaultArg(given[
        ...
        Tone.prototype.optionsObject = function(values, keys,
            defaults) {
            var options = {};
        ...
        Tone.prototype.isObject = function(arg) {
            return Object.prototype.toString.call(arg) ===
                '[object Object]' && arg.constructor === Object;
        };
    ...
    Tone_signal_SignalBase = function(Tone) {
        ...
        Tone.SignalBase.prototype.connect = function(node,
            outputNumber, inputNumber) {
            if (Tone.Signal && Tone.Signal === node.constructor ||
                Tone.Param && Tone.Param === node.constructor ||
                Tone.TimelineSignal && Tone.TimelineSignal ===
                node.constructor) {
            ...
            Tone.prototype.connect.call(this, node,
                outputNumber, inputNumber);
            return this;
        };
    ...
    Tone_signal_WaveShaper = function(Tone) {
        ...
        Tone.WaveShaper = function(mapping, bufferLen) {
            this._shaper = this.input = this.output = this.context
                .createWaveShaper();
            this._curve = null;
            if (Array.isArray(mapping)) {
                this.curve = mapping;
            } else if (isFinite(mapping) || this.isUndef(
                    mapping)) {
                this._curve = new Float32Array(this.defaultArg(
                    mapping, 1024));
        ...
        Object.defineProperty(Tone.WaveShaper.prototype,
            'oversample', {
                get: function() {
                ...
                set: function(oversampling) {
                    if ([
                        ...
                        this._shaper.oversample =
                            oversampling;
                    } else {
                        throw new Error(
                            'invalid oversampling: ' +
                            oversampling);
                    }
                }
            });
    ...
    Tone_core_Type = function(Tone) {
        ...
        Tone.prototype.isTransportTime = function() {
            ...
            return function(transportTime) {
                return transportTimeFormat.test(
                    transportTime);
            };
        }();
        Tone.prototype.isNote = function() {
            var noteFormat = new RegExp(
                /^[a-g]{1}(b|#|x|bb)?-?[0-9]+$/i);
            return function(note) {
        ...
        Tone.prototype.transportTimeToSeconds = function(
            transportTime, bpm, timeSignature) {
            bpm = this.defaultArg(bpm, getTransportBpm());
            timeSignature = this.defaultArg(timeSignature,
                getTransportTimeSignature());
            var measures = 0;
            ...
            var beats = measures * timeSignature + quarters +
                sixteenths / 4;
            return beats * (60 / bpm);
        };
        ...
        Tone.prototype.toTransportTime = function(time, bpm,
            timeSignature) {
            var seconds = this.toSeconds(time);
            return this.secondsToTransportTime(seconds, bpm,
                timeSignature);
        };
        Tone.prototype.toFrequency = function(freq, now) {
            if (this.isFrequency(freq)) {
                return parseFloat(freq);
            } else if (this.isNotation(freq) || this.isTransportTime(
                    freq)) {
                return this.secondsToFrequency(this.toSeconds(
                    freq, now));
            ...
            if (this.isNumber(time)) {
                ...
                if (betweenParens) {
                    for (var j = 0; j < betweenParens.length; j++) {
                        var symbol = betweenParens[j].replace(
                            /[\(\)]/g, '');
                        var symbolVal = this.toSeconds(symbol);
                        time = time.replace(betweenParens[j],
                            symbolVal);
                    }
                }
                if (time.indexOf('@') !== -1) {
                    ...
                    if (!this.isUndef(Tone.Transport)) {
                        ...
                        time = Tone.Transport.quantize(
                            toQuantize, subdivision);
                    } else {
                        throw new Error(
                            'quantization requires Tone.Transport'
                        );
                    }
                } else {
        ...
        Tone.prototype.toNotation = function(time, bpm,
            timeSignature) {
            var testNotations = [
                '1m',
                '2n',
            ...
            var retNotation = toNotationHelper.call(this, time,
                bpm, timeSignature, testNotations);
            ...
            var retTripletNotation = toNotationHelper.call(this,
                time, bpm, timeSignature,
                testTripletNotations);
            if (retTripletNotation.split('+').length <
        ...
        function toNotationHelper(time, bpm, timeSignature,
            testNotations) {
            var seconds = this.toSeconds(time);
            var threshold = this.notationToSeconds(testNotations[
                    testNotations.length - 1], bpm,
                timeSignature);
            var retNotation = '';
            for (var i = 0; i < testNotations.length; i++) {
                var notationTime = this.notationToSeconds(
                    testNotations[i], bpm, timeSignature);
        ...
        Tone.prototype.noteToFrequency = function(note) {
            ...
            if (parts.length === 3) {
                ...
                var octave = parts[1];
                var noteNumber = index + (parseInt(octave, 10) +
                    1) * 12;
    ...
    Tone_core_Param = function(Tone) {
        ...
        Object.defineProperty(Tone.Param.prototype, 'value', {
            ...
            set: function(value) {
                var convertedVal = this._fromUnits(
                    value);
        ...
        Tone.Param.prototype.setValueAtTime = function(value, time) {
            ...
            this._param.setValueAtTime(value, this.toSeconds(
                time));
            return this;
        };
        ...
        Tone.Param.prototype.linearRampToValueAtTime = function(
            value, endTime) {
            value = this._fromUnits(value);
            this._param.linearRampToValueAtTime(value, this.toSeconds(
                endTime));
            return this;
        };
        Tone.Param.prototype.exponentialRampToValueAtTime =
            function(value, endTime) {
                value = this._fromUnits(value);
                value = Math.max(this._minOutput, value);
                this._param.exponentialRampToValueAtTime(value,
        ...
        Tone.Param.prototype.exponentialRampToValue = function(
            ...
            this.setValueAtTime(Math.max(currentVal, this._minOutput),
                now);
            this.exponentialRampToValueAtTime(value, now + this
                .toSeconds(rampTime));
            return this;
        };
        Tone.Param.prototype.linearRampToValue = function(value,
            rampTime) {
            var now = this.now();
            this.setRampPoint(now);
            this.linearRampToValueAtTime(value, now + this.toSeconds(
                rampTime));
            return this;
        };
        Tone.Param.prototype.setTargetAtTime = function(value,
            startTime, timeConstant) {
            value = this._fromUnits(value);
            value = Math.max(this._minOutput, value);
            timeConstant = Math.max(this._minOutput,
                timeConstant);
            this._param.setTargetAtTime(value, this.toSeconds(
                startTime), timeConstant);
            return this;
        };
        Tone.Param.prototype.setValueCurveAtTime = function(values,
            startTime, duration) {
            for (var i = 0; i < values.length; i++) {
                values[i] = this._fromUnits(values[i]);
            }
            this._param.setValueCurveAtTime(values, this.toSeconds(
                startTime), this.toSeconds(duration));
            return this;
        };
        Tone.Param.prototype.cancelScheduledValues = function(
            startTime) {
            this._param.cancelScheduledValues(this.toSeconds(
                startTime));
            return this;
        };
        Tone.Param.prototype.rampTo = function(value, rampTime) {
            rampTime = this.defaultArg(rampTime, 0);
            if (this.units === Tone.Type.Frequency || this.units ===
                Tone.Type.BPM) {
    ...
    Tone_core_Gain = function(Tone) {
        ...
        Tone.Gain = function() {
            ...
            this.input = this.output = this._gainNode = this.context
                .createGain();
    ...
    Tone_signal_Signal = function(Tone) {
        ...
        Tone._initAudioContext(function(audioContext) {
            var buffer = audioContext.createBuffer(1, 128,
            ...
            Tone.Signal._constant.channelCountMode =
                'explicit';
    ...
    Tone_signal_Add = function(Tone) {
        ...
        Tone.Add = function(value) {
            Tone.call(this, 2, 0);
            this._sum = this.input[0] = this.input[1] = this.output =
    ...
    Tone_signal_Multiply = function(Tone) {
        ...
        Tone.Multiply = function(value) {
            Tone.call(this, 2, 0);
            this._mult = this.input[0] = this.output = this.context
                .createGain();
    ...
    signal = function() {
         ...
         */
        Signal.prototype.scale = function(inMin, inMax, outMin,
            outMax) {
            var mapOutMin, mapOutMax;
            if (arguments.length === 4) {
                mapOutMin = p5.prototype.map(outMin, inMin,
                    inMax, 0, 1) - 0.5;
                mapOutMax = p5.prototype.map(outMax, inMin,
                    inMax, 0, 1) - 0.5;
            } else {
    ...
    oscillator = function() {
        ...
        p5.Oscillator = function(freq, type) {
            ...
            this.f = freq || 440;
            // frequency
            this.oscillator.frequency.setValueAtTime(this.f,
            ...
            this.output.gain.setValueAtTime(0.5, p5sound.audiocontext
                .currentTime);
            ...
            this.panner = new p5.Panner(this.output, this.connection,
                1);
        ...
        p5.Oscillator.prototype.start = function(time, f) {
            ...
            if (!this.started) {
                ...
                this.oscillator.frequency.exponentialRampToValueAtTime(
                    Math.abs(freq), p5sound.audiocontext.currentTime
                );
                this.oscillator.type = type;
                // this.oscillator.detune.value = detune;
                this.oscillator.connect(this.output);
                time = time || 0;
                this.oscillator.start(time + p5sound.audiocontext
                    .currentTime);
                this.freqNode = this.oscillator.frequency;
                // if other oscillators are already connected to this osc's freq
                for (var i in this._freqMods) {
                    if (typeof this._freqMods[i].connect !==
                        'undefined') {
                        this._freqMods[i].connect(this.oscillator
                            .frequency);
                    }
                }
                this.started = true;
         ...
         */
        p5.Oscillator.prototype.amp = function(vol, rampTime,
            tFromNow) {
            var self = this;
            if (typeof vol === 'number') {
                var rampTime = rampTime || 0;
         ...
         *  </code></div>
         */
        p5.Oscillator.prototype.freq = function(val, rampTime,
            tFromNow) {
        ...
        p5.Oscillator.prototype.phase = function(p) {
            var delayAmt = p5.prototype.map(p, 0, 1, 0, 1 /
                this.f);
            var now = p5sound.audiocontext.currentTime;
            this.phaseAmount = p;
            if (!this.dNode) {
        ...
        var sigChain = function(o, mathObj, thisChain, nextChain,
            type) {
        ...
        p5.Oscillator.prototype.add = function(num) {
            ...
            return sigChain(this, add, thisChain, nextChain,
                Add);
        };
        /**
        ...
        p5.Oscillator.prototype.mult = function(num) {
            ...
            var thisChain = this.mathOps.length - 1;
            var nextChain = this.output;
            return sigChain(this, mult, thisChain, nextChain,
                Mult);
        };
        /**
         ...
         *                                     with scaled output
         */
        p5.Oscillator.prototype.scale = function(inMin, inMax,
            outMin, outMax) {
            var mapOutMin, mapOutMax;
            if (arguments.length === 4) {
                mapOutMin = p5.prototype.map(outMin, inMin,
    ...
    }(master, Tone_signal_Signal, Tone_signal_Add,
        Tone_signal_Multiply, Tone_signal_Scale);
    /** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
    ...
    Tone_core_Timeline = function(Tone) {
        ...
        Tone.Timeline.prototype.cancel = function(after) {
            if (this._timeline.length > 1) {
                ...
                if (index >= 0) {
                    this._timeline = this._timeline.slice(0,
                        index);
                } else {
                    this._timeline = [];
                }
        ...
        Tone.Timeline.prototype._search = function(time) {
            ...
            while (beginning <= end && beginning < len) {
                var midPoint = Math.floor(beginning + (end -
                    beginning) / 2);
        ...
        Tone.Timeline.prototype._iterate = function(callback,
            lowerBound, upperBound) {
            this._iterating = true;
            lowerBound = this.defaultArg(lowerBound, 0);
            upperBound = this.defaultArg(upperBound, this._timeline
                .length - 1);
            ...
            if (this._toRemove.length > 0) {
                for (var j = 0; j < this._toRemove.length; j++) {
                    var index = this._timeline.indexOf(this._toRemove[
                        j]);
                    if (index !== -1) {
                        this._timeline.splice(index, 1);
                    }
        ...
        Tone.Timeline.prototype.forEachBefore = function(time,
            callback) {
            time = this.toSeconds(time);
        ...
        Tone.Timeline.prototype.forEachAfter = function(time,
            callback) {
            time = this.toSeconds(time);
        ...
        Tone.Timeline.prototype.forEachFrom = function(time,
            callback) {
            time = this.toSeconds(time);
            var lowerBound = this._search(time);
            while (lowerBound >= 0 && this._timeline[lowerBound]
                .time >= time) {
                lowerBound--;
            }
            this._iterate(callback, lowerBound + 1);
        ...
        Tone.Timeline.prototype.forEachAtTime = function(time,
            callback) {
            time = this.toSeconds(time);
            var upperBound = this._search(time);
            if (upperBound !== -1) {
    ...
    Tone_signal_TimelineSignal = function(Tone) {
        ...
        Object.defineProperty(Tone.TimelineSignal.prototype,
            'value', {
                get: function() {
                    return this._toUnits(this._param.value);
                },
        ...
        Tone.TimelineSignal.prototype.exponentialRampToValueAtTime =
            function(value, endTime) {
                value = this._fromUnits(value);
                value = Math.max(this._minOutput, value);
                endTime = this.toSeconds(endTime);
        ...
        Tone.TimelineSignal.prototype.setTargetAtTime = function(
            ...
            this._param.setTargetAtTime(value, startTime,
                timeConstant);
            return this;
        };
        Tone.TimelineSignal.prototype.cancelScheduledValues =
            function(after) {
        ...
        Tone.TimelineSignal.prototype.setRampPoint = function(time) {
            ...
            if (after) {
                ...
                } else if (after.type === Tone.TimelineSignal.Type
                    .Exponential) {
        ...
        Tone.TimelineSignal.prototype.linearRampToValueBetween =
        ...
        Tone.TimelineSignal.prototype.getValueAtTime = function(
            time) {
            var after = this._searchAfter(time);
            ...
            if (before === null) {
                value = this._initial;
            } else if (before.type === Tone.TimelineSignal.Type
                .Target) {
                var previous = this._events.getEventBefore(
                    before.time);
                var previouVal;
                if (previous === null) {
                ...
                value = this._exponentialApproach(before.time,
                    previouVal, before.value, before.constant,
                    time);
            } else if (after === null) {
                value = before.value;
            } else if (after.type === Tone.TimelineSignal.Type.Linear) {
                value = this._linearInterpolate(before.time,
                    before.value, after.time, after.value,
                    time);
            } else if (after.type === Tone.TimelineSignal.Type.Exponential) {
                value = this._exponentialInterpolate(before.time,
                    before.value, after.time, after.value,
                    time);
            } else {
                value = before.value;
        ...
        Tone.TimelineSignal.prototype.connect = Tone.SignalBase.prototype
            .connect;
        Tone.TimelineSignal.prototype._exponentialApproach =
            function(t0, v0, v1, timeConstant, t) {
                return v1 + (v0 - v1) * Math.exp(-(t - t0) /
                    timeConstant);
            };
        ...
        Tone.TimelineSignal.prototype._exponentialInterpolate =
            function(t0, v0, t1, v1, t) {
    ...
    env = function() {
         ...
         *  </code></div>
         */
        p5.Env.prototype.setADSR = function(aTime, dTime, sPercent,
            rTime) {
            this.aTime = aTime;
            this.dTime = dTime || 0;
            // lerp
            this.sPercent = sPercent || 0;
            this.dLevel = typeof sPercent !== 'undefined' ?
        ...
        p5.Env.prototype._setRampAD = function(t1, t2) {
            ...
            TCDenominator = Math.log(1 / this.checkExpInput(1 -
                this._rampHighPercentage));
            this._rampAttackTC = t1 / this.checkExpInput(
                TCDenominator);
            TCDenominator = Math.log(1 / this._rampLowPercentage);
            this._rampDecayTC = t2 / this.checkExpInput(
                TCDenominator);
        };
        // private method
        ...
        p5.Env.prototype.play = function(unit, secondsFromNow,
            ...
            this.triggerRelease(unit, tFromNow + this.aTime +
                this.dTime + susTime);
        };
        /**
         ...
         *  </code></div>
         */
        p5.Env.prototype.triggerAttack = function(unit,
            secondsFromNow) {
            var now = p5sound.audiocontext.currentTime;
            var tFromNow = secondsFromNow || 0;
            var t = now + tFromNow;
            ...
            if (this.isExponential == true) {
                ...
                this.control.linearRampToValueAtTime(valToSet,
                    t);
            }
            ...
            if (this.isExponential == true) {
                this.control.exponentialRampToValueAtTime(this.checkExpInput(
                    this.aLevel), t);
                valToSet = this.checkExpInput(this.control.getValueAtTime(
                    t));
                this.control.cancelScheduledValues(t);
                this.control.exponentialRampToValueAtTime(
                    valToSet, t);
            } else {
                this.control.linearRampToValueAtTime(this.aLevel,
                    t);
            ...
            if (this.isExponential == true) {
                ...
                this.control.linearRampToValueAtTime(this.dLevel,
                    t);
                valToSet = this.control.getValueAtTime(t);
                this.control.cancelScheduledValues(t);
                this.control.linearRampToValueAtTime(valToSet,
         ...
         *  </code></div>
         */
        p5.Env.prototype.triggerRelease = function(unit,
            secondsFromNow) {
            ...
            if (this.isExponential == true) {
                ...
                this.control.linearRampToValueAtTime(this.rLevel,
                    t);
                valToSet = this.control.getValueAtTime(t);
                this.control.cancelScheduledValues(t);
                this.control.linearRampToValueAtTime(valToSet,
         ...
         *  </code></div>
         */
        p5.Env.prototype.ramp = function(unit, secondsFromNow, v1,
            v2) {
            var now = p5sound.audiocontext.currentTime;
            var tFromNow = secondsFromNow || 0;
            var t = now + tFromNow;
            var destination1 = this.checkExpInput(v1);
            var destination2 = typeof v2 !== 'undefined' ? this
                .checkExpInput(v2) : undefined;
            ...
            //get current value
            var currentVal = this.checkExpInput(this.control.getValueAtTime(
                t));
            this.control.cancelScheduledValues(t);
            //if it's going up
            ...
            if (destination2 > destination1) {
                this.control.setTargetAtTime(destination2, t,
                    this._rampAttackTC);
        ...
        p5.Env.prototype.connect = function(unit) {
            ...
            if (unit instanceof p5.Oscillator || unit instanceof p5
                .SoundFile || unit instanceof p5.AudioIn ||
                unit instanceof p5.Reverb || unit instanceof p5
                .Noise || unit instanceof p5.Filter || unit instanceof p5
                .Delay) {
        ...
        p5.Env.prototype.add = function(num) {
            ...
            var nextChain = this.output;
            return p5.prototype._mathChain(this, add, thisChain,
                nextChain, Add);
        };
        /**
        ...
        p5.Env.prototype.mult = function(num) {
            ...
            var thisChain = this.mathOps.length;
            var nextChain = this.output;
            return p5.prototype._mathChain(this, mult,
                thisChain, nextChain, Mult);
        };
        /**
         ...
         *                                     with scaled output
         */
        p5.Env.prototype.scale = function(inMin, inMax, outMin,
            outMax) {
            var scale = new Scale(inMin, inMax, outMin, outMax);
            var thisChain = this.mathOps.length;
            var nextChain = this.output;
            return p5.prototype._mathChain(this, scale,
                thisChain, nextChain, Scale);
        };
        // get rid of the oscillator
    ...
    }(master, Tone_signal_Add, Tone_signal_Multiply,
        Tone_signal_Scale, Tone_signal_TimelineSignal,
        Tone_core_Tone);
    var pulse;
    pulse = function() {
        'use strict';
        ...
        p5.Pulse.prototype.width = function(w) {
            if (typeof w === 'number') {
                if (w <= 1 && w >= 0) {
                    ...
                    var mW = this.w / this.oscillator.frequency
                        .value;
                    this.dNode.delayTime.value = mW;
                }
                this.dcGain.gain.value = 1.7 * (0.5 - this.w);
        ...
        p5.Pulse.prototype.start = function(f, time) {
            ...
            if (!this.started) {
                ...
                var type = this.oscillator.type;
                this.oscillator = p5sound.audiocontext.createOscillator();
                this.oscillator.frequency.setValueAtTime(freq,
                    now);
                this.oscillator.type = type;
                this.oscillator.connect(this.output);
    ...
    noise = function() {
        ...
        var _whiteNoise = function() {
            ...
            var whiteBuffer = p5sound.audiocontext.createBuffer(
                1, bufferSize, p5sound.audiocontext.sampleRate
            );
        ...
        var _pinkNoise = function() {
            ...
            for (var i = 0; i < bufferSize; i++) {
                ...
                noiseData[i] = b0 + b1 + b2 + b3 + b4 + b5 + b6 +
                    white * 0.5362;
                noiseData[i] *= 0.11;
    ...
    audioin = function() {
         ...
         *                                    getUserMedia.
         */
        p5.AudioIn.prototype.start = function(successCallback,
            errorCallback) {
            var self = this;
            ...
            if (p5sound.inputSources[self.currentSource]) {
                ...
                window.navigator.getUserMedia(constraints, this
                    ._onStream = function(stream) {
                        self.stream = stream;
                        self.enabled = true;
                        // Wrap a MediaStreamSourceNode around the live input
                        self.mediaStream = p5sound.audiocontext
        ...
        p5.AudioIn.prototype.amp = function(vol, t) {
            if (t) {
                var rampTime = t || 0;
                var currentVol = this.output.gain.value;
                this.output.gain.cancelScheduledValues(p5sound.audiocontext
                    .currentTime);
                this.output.gain.setValueAtTime(currentVol,
                    p5sound.audiocontext.currentTime);
                this.output.gain.linearRampToValueAtTime(vol,
                ...
                this.output.gain.cancelScheduledValues(p5sound.audiocontext
                    .currentTime);
                this.output.gain.setValueAtTime(vol, p5sound.audiocontext
                    .currentTime);
            }
        };
        ...
        p5.AudioIn.prototype.getSources = function(callback) {
            if (typeof window.MediaStreamTrack.getSources ===
                'function') {
        ...
        p5.AudioIn.prototype.setSource = function(num) {
            ...
            var self = this;
            if (p5sound.inputSources.length > 0 && num <
                p5sound.inputSources.length) {
                // set the current source
                self.currentSource = num;
                console.log('set source to ' + p5sound.inputSources[
    ...
    filter = function() {
        ...
        p5.Filter.prototype.freq = function(freq, time) {
            ...
            if (typeof freq === 'number') {
                ...
                self.biquad.frequency.exponentialRampToValueAtTime(
                    freq, this.ac.currentTime + 0.02 + t);
            } else if (freq) {
        ...
        p5.Filter.prototype.res = function(res, time) {
            ...
            if (typeof res == 'number') {
                ...
                self.biquad.Q.cancelScheduledValues(self.ac.currentTime +
                    0.01 + t);
                self.biquad.Q.linearRampToValueAtTime(res, self
                    .ac.currentTime + 0.02 + t);
            } else if (res) {
        ...
        p5.Filter.prototype.amp = function(vol, rampTime, tFromNow) {
            ...
            var currentVol = this.output.gain.value;
            this.output.gain.cancelScheduledValues(now);
            this.output.gain.linearRampToValueAtTime(currentVol,
                now + tFromNow + 0.001);
            this.output.gain.linearRampToValueAtTime(vol, now +
                tFromNow + rampTime + 0.001);
        };
        /**
         *  Send output to a p5.sound or web audio object
         *
    ...
    delay = function() {
        ...
        p5.Delay = function() {
            ...
            this._rightFilter.biquad.frequency.setValueAtTime(
                1200, this.ac.currentTime);
            this._leftFilter.biquad.Q.setValueAtTime(0.3, this.ac
                .currentTime);
            this._rightFilter.biquad.Q.setValueAtTime(0.3, this
                .ac.currentTime);
            // graph routing
            ...
            this._leftFilter.biquad.gain.setValueAtTime(1, this
                .ac.currentTime);
            this._rightFilter.biquad.gain.setValueAtTime(1,
                this.ac.currentTime);
            // default routing
            this.setType(0);
         ...
         *                               delay.
         */
        p5.Delay.prototype.process = function(src, _delayTime,
            _feedback, _filter) {
            ...
            src.connect(this.input);
            this.leftDelay.delayTime.setValueAtTime(delayTime,
                this.ac.currentTime);
            this.rightDelay.delayTime.setValueAtTime(delayTime,
                this.ac.currentTime);
            this._leftGain.gain.setValueAtTime(feedback, this.ac
                .currentTime);
            this._rightGain.gain.setValueAtTime(feedback, this.ac
                .currentTime);
            if (_filter) {
        ...
        p5.Delay.prototype.setType = function(t) {
            ...
            switch (t) {
                case 'pingPong':
                    this._rightFilter.setType(this._leftFilter.biquad
                        .type);
                    this._leftFilter.output.connect(this._merge,
                        0, 0);
                    this._rightFilter.output.connect(this._merge,
                        0, 1);
    ...
    reverb = function() {
         ...
         */
        p5.Reverb.prototype.process = function(src, seconds,
            decayRate, reverse) {
            src.connect(this.input);
            var rebuild = false;
            if (seconds) {
         ...
         *  @param  {Boolean} [reverse] Play the reverb backwards or forwards.
         */
        p5.Reverb.prototype.set = function(seconds, decayRate,
            reverse) {
            var rebuild = false;
            if (seconds) {
                this._seconds = seconds;
        ...
        p5.Reverb.prototype._buildImpulse = function() {
            ...
            for (i = 0; i < length; i++) {
                ...
                impulseL[i] = (Math.random() * 2 - 1) * Math.pow(
                    1 - n / length, decay);
                impulseR[i] = (Math.random() * 2 - 1) * Math.pow(
                    1 - n / length, decay);
            }
         ...
         *  @private
         */
        p5.Convolver.prototype._loadBuffer = function(path,
                ...
                if (request.status == 200) {
                    ...
                    ac.decodeAudioData(request.response,
                        function(buff) {
                            ...
                            buffer.name = chunks[chunks
                                .length - 1];
                            buffer.audioBuffer = buff;
                            self.impulses.push(buffer);
                            self.convolverNode.buffer =
                                buffer.audioBuffer;
                            if (callback) {
                                callback(buffer);
                            }
            ...
            // if there is another error, aside from 404...
            request.onerror = function(e) {
                var err = new CustomError('loadConvolver',
                    errorTrace, self.url);
                var msg =
                    'There was no response from the server at ' +
                    self.url +
         ...
         *  @param  {Function} errorCallback function (optional)
         */
        p5.Convolver.prototype.resetImpulse = function(path,
            callback, errorCallback) {
            // if loading locally without a server
            if (window.location.origin.indexOf('file://') > -1 &&
                window.cordova === 'undefined') {
            ...
            if (typeof id === 'string') {
                for (var i = 0; i < this.impulses.length; i++) {
                    if (this.impulses[i].name === id) {
                        this.convolverNode.buffer = this.impulses[
                            i].audioBuffer;
                        break;
                    }
                }
    ...
    Tone_core_Clock = function(Tone) {
        ...
        Tone.Clock = function() {
            ...
            this._lastUpdate = 0;
            this._loopID = -1;
            this.frequency = new Tone.TimelineSignal(options.frequency,
                Tone.Type.Frequency);
            this.ticks = 0;
        ...
        Object.defineProperty(Tone.Clock.prototype, 'lookAhead', {
            ...
            set: function(val) {
                if (val === 'auto') {
                    ...
                    this._lookAhead = this.toSeconds(
                        val);
                }
            }
        });
        Tone.Clock.prototype.start = function(time, offset) {
            time = this.toSeconds(time);
            if (this._state.getStateAtTime(time) !== Tone.State
                .Started) {
        ...
        Tone.Clock.prototype.stop = function(time) {
            ...
            if (this._state.getStateAtTime(time) !== Tone.State
                .Stopped) {
                this._state.setStateAtTime(Tone.State.Stopped,
                    time);
            }
            return this;
        };
        Tone.Clock.prototype.pause = function(time) {
            ...
            if (this._state.getStateAtTime(time) === Tone.State
                .Started) {
                this._state.setStateAtTime(Tone.State.Paused,
                    time);
            }
            return this;
        };
        Tone.Clock.prototype._loop = function(time) {
            ...
            if (event) {
                state = event.state;
                if (this._nextTick === -1 && state === Tone.State
                    .Started) {
            ...
            if (state === Tone.State.Started) {
                while (now + lookAhead > this._nextTick) {
                    ...
                    this._nextTick += 1 / this.frequency.getValueAtTime(
                        this._nextTick);
    ...
    metro = function() {
        ...
        p5.Metro.prototype.ontick = function(tickTime) {
            ...
            var secondsFromNow = tickTime - p5sound.audiocontext
                .currentTime;
            if (elapsedTime - tatumTime <= -0.02) {
                ...
                for (var i in this.syncedParts) {
                    ...
                    for (var j in thisPart.phrases) {
                        ...
                        var bNum = this.metroTicks %
                            phraseArray.length;
                        if (phraseArray[bNum] !== 0 && (this.metroTicks <
                                phraseArray.length || !
                                thisPhrase.looping)) {
                            thisPhrase.callback(secondsFromNow,
                                phraseArray[bNum]);
                        }
                    }
                }
        ...
        p5.Metro.prototype.setBPM = function(bpm, rampTime) {
            ...
            tatumTime = beatTime;
            var rampTime = rampTime || 0;
            this.clock.frequency.setValueAtTime(this.clock.frequency
                .value, now);
            this.clock.frequency.linearRampToValueAtTime(bpm,
                now + rampTime);
            this.bpm = bpm;
        };
    ...
    looper = function() {
         ...
         */
        p5.Part.prototype.addPhrase = function(name, callback,
            array) {
            var p;
    ...
    soundRecorder = function() {
        ...
        p5.SoundRecorder = function() {
            ...
            this._jsNode = ac.createScriptProcessor(this.bufferSize,
                this._channels, 2);
            this._jsNode.onaudioprocess = this._audioprocess.bind(
                this);
            /**
         ...
         */
        p5.SoundRecorder.prototype.record = function(sFile,
            duration, callback) {
            this.recording = true;
            if (duration) {
        ...
        p5.SoundRecorder.prototype._audioprocess = function(event) {
            if (this.recording === false) {
                ...
                if (this.sampleLimit && this.recordedSamples >=
                    this.sampleLimit) {
                    this.stop();
                } else {
                    // get channel data
                    var left = event.inputBuffer.getChannelData(
                        0);
                    var right = event.inputBuffer.getChannelData(
                        1);
                    // clone the samples
                    this._leftBuffers.push(new Float32Array(
                        left));
                    this._rightBuffers.push(new Float32Array(
                        right));
        ...
        p5.SoundRecorder.prototype._mergeBuffers = function(
            channelBuffer) {
        ...
        p5.prototype.saveSound = function(soundFile, name) {
            ...
            var rightChannel = soundFile.buffer.getChannelData(
                1);
            var interleaved = interleave(leftChannel,
                rightChannel);
            ...
            var volume = 1;
            for (var i = 0; i < lng; i++) {
                view.setInt16(index, interleaved[i] * (32767 *
                    volume), true);
                index += 2;
            }
    ...
    peakdetect = function() {
         ...
         *  </code></div>
         */
        p5.PeakDetect = function(freq1, freq2, threshold,
            _framesPerPeak) {
            var framesPerPeak;
        ...
        p5.PeakDetect.prototype.update = function(fftObject) {
            var nrg = this.energy = fftObject.getEnergy(this.f1,
                this.f2) / 255;
            if (nrg > this.cutoff && nrg > this.threshold &&
                nrg - this.penergy > 0) {
                // trigger callback
                this._onPeak();
    ...
    src_app = function() {
        ...
        var p5SOUND = sndcore;
        return p5SOUND;
    }(sndcore, master, helpers, errorHandler, panner, soundfile,
        amplitude, fft, signal, oscillator, env, pulse, noise,
        audioin, filter, delay, reverb, metro, looper,
        soundRecorder, peakdetect, gain);
}));
