...
(function(root, factory) {
                ...
                this.bufferSourceNode.onended = function(e) {
                    ...
                    setTimeout(function() {
                        self.bufferSourceNodes.splice(
                            theNode._arrayIndex,
                            1);
                        if (self.bufferSourceNodes.length ===
                            0) {
                            self._playing = false;
                        }
                    }, 1);
    ...
    Tone_core_Tone = function() {
        ...
        if (typeof AudioContext.prototype.createDelay !==
            'function') {
            AudioContext.prototype.createDelay = AudioContext.prototype
                .createDelayNode;
        }
        if (typeof AudioContext.prototype.createPeriodicWave !==
            'function') {
            AudioContext.prototype.createPeriodicWave =
                AudioContext.prototype.createWaveTable;
        }
        if (typeof AudioBufferSourceNode.prototype.start !==
            'function') {
            AudioBufferSourceNode.prototype.start =
                AudioBufferSourceNode.prototype.noteGrainOn;
        }
        if (typeof AudioBufferSourceNode.prototype.stop !==
            'function') {
        ...
        if (!window.Tone) {
            AudioNode.prototype._nativeConnect = AudioNode.prototype
                .connect;
        ...
        Tone.prototype.defaultArg = function(given, fallback) {
            if (typeof given === 'object' && typeof fallback ===
                'object') {
                var ret = {};
                for (var givenProp in given) {
                    ret[givenProp] = this.defaultArg(given[
                        givenProp], given[givenProp]);
                }
                for (var prop in fallback) {
                    ret[prop] = this.defaultArg(given[prop],
                        fallback[prop]);
                }
                return ret;
            } else {
        ...
        Tone.prototype.optionsObject = function(values, keys,
            defaults) {
            var options = {};
            if (values.length === 1 && typeof values[0] ===
                'object') {
                options = values[0];
            } else {
        ...
        Tone.prototype.logScale = function(gain) {
            return Math.max(this.normalize(this.gainToDb(gain), -
                100, 0), 0);
        };
        ...
        Tone.prototype.interpolate = function(input, outputMin,
            outputMax) {
            return input * (outputMax - outputMin) + outputMin;
        };
        Tone.prototype.normalize = function(input, inputMin,
            inputMax) {
    ...
    Tone_signal_WaveShaper = function(Tone) {
        ...
        Tone.WaveShaper.prototype.setOversample = function(
            oversampling) {
            this._shaper.oversample = oversampling;
        };
        Tone.WaveShaper.prototype._isSafari = function() {
            var ua = navigator.userAgent.toLowerCase();
            return ua.indexOf('safari') !== -1 && ua.indexOf(
                'chrome') === -1;
        };
    ...
    Tone_signal_Signal = function(Tone) {
        ...
        Tone.Signal.prototype.setValueAtTime = function(value, time) {
            value *= this._syncRatio;
            this._scalar.gain.setValueAtTime(value, this.toSeconds(
                time));
        };
        ...
        Tone.Signal.prototype.linearRampToValueAtTime = function(
            value, endTime) {
            value *= this._syncRatio;
            this._scalar.gain.linearRampToValueAtTime(value,
                this.toSeconds(endTime));
        };
        Tone.Signal.prototype.exponentialRampToValueAtTime =
            function(value, endTime) {
                value *= this._syncRatio;
                try {
                    this._scalar.gain.exponentialRampToValueAtTime(
                        value, this.toSeconds(endTime));
                } catch (e) {
                    this._scalar.gain.linearRampToValueAtTime(value,
                        this.toSeconds(endTime));
                }
        ...
        Tone.Signal.prototype.linearRampToValueNow = function(value,
            endTime) {
            var now = this.now();
            this.setCurrentValueNow(now);
            value *= this._syncRatio;
        ...
        Tone.Signal.prototype.setTargetAtTime = function(value,
            startTime, timeConstant) {
            value *= this._syncRatio;
            this._scalar.gain.setTargetAtTime(value, this.toSeconds(
                startTime), timeConstant);
        };
        ...
        Tone.Signal.prototype.cancelScheduledValues = function(
            startTime) {
            this._scalar.gain.cancelScheduledValues(this.toSeconds(
                startTime));
        };
    ...
    Tone_signal_Add = function(Tone) {
        ...
        Tone.Add.prototype.setValue = function(value) {
            if (this._value !== null) {
                ...
                throw new Error(
                    'cannot switch from signal to number');
            }
        };
    ...
    oscillator = function() {
        ...
        p5.Oscillator.prototype.phase = function(p) {
            ...
            var now = p5sound.audiocontext.currentTime;
            this.dNode.delayTime.linearRampToValueAtTime(p5.prototype
                .map(p, 0, 1, 0, 1 / this.oscillator.frequency
                    .value), now);
        };
        // ========================== //
    ...
    env = function() {
         ...
         *  @param {Number} [rLevel]  Amplitude 0.0 to 1.0
         */
        p5.Env.prototype.set = function(t1, l1, t2, l2, t3, l3, t4,
            l4) {
            this.aTime = t1;
            this.aLevel = l1;
            this.dTime = t2 || 0;
        ...
        p5.Env.prototype.play = function(unit, secondsFromNow) {
            ...
            this.control.linearRampToValueAtTime(this.dLevel, t +
                this.aTime + this.dTime);
            // hold sustain level
            this.control.linearRampToValueAtTime(this.sLevel, t +
                this.aTime + this.dTime + this.sTime);
            // release
            this.control.linearRampToValueAtTime(this.rLevel, t +
                this.aTime + this.dTime + this.sTime + this
                .rTime);
            var clearTime = t + this.aTime + this.dTime + this.sTime +
                this.rTime;
        };
        /**
        ...
        p5.Env.prototype.triggerRelease = function(unit,
            ...
            if (now - this.lastAttack < this.aTime) {
                ...
                this.control.linearRampToValueAtTime(this.dLevel,
                    t + a + this.dTime);
                this.control.linearRampToValueAtTime(this.sLevel,
                ...
                var s = this.aTime + this.dTime + this.sTime -
                    (now - this.lastAttack);
                this.control.linearRampToValueAtTime(this.sLevel,
                    t + s);
                this.control.linearRampToValueAtTime(this.rLevel,
        ...
        Tone_signal_Scale, Tone_core_Tone);
    var pulse;
    pulse = function() {
        'use strict';
        var p5sound = master;
    ...
    audioin = function() {
        ...
        p5.AudioIn.prototype.start = function() {
            ...
            if (p5sound.inputSources[self.currentSource]) {
                ...
                navigator.getUserMedia(constraints, this._onStream =
                    function(stream) {
                        self.stream = stream;
                        self.enabled = true;
            ...
            request.onload = function() {
                ...
                ac.decodeAudioData(request.response,
                    function(buff) {
                        ...
                        buffer.name = chunks[chunks.length -
                            1];
    ...
    Tone_core_Clock = function(Tone) {
        ...
        Tone.Clock = function(rate, callback) {
            ...
            this._jsNode = this.context.createScriptProcessor(
                this.bufferSize, 1, 1);
            this._jsNode.onaudioprocess = this._processBuffer.bind(
                this);
        ...
        Tone.Clock.prototype.setRate = function(rate, rampTime) {
            var freqVal = this.secondsToFrequency(this.toSeconds(
                rate));
            if (!rampTime) {
        ...
        Tone.Clock.prototype._processBuffer = function(event) {
            ...
            var incomingBuffer = event.inputBuffer.getChannelData(
                0);
            ...
            for (var i = 0; i < bufferSize; i++) {
                ...
                if (sample > 0 && !upTick) {
                    upTick = true;
                    setTimeout(function() {
                        var tickTime = now + self.samplesToSeconds(
                            i + bufferSize * 2);
                        return function() {
                            self.tick(tickTime);
                        };
    ...
    metro = function() {
        ...
        // var upTick = false;
        p5.Metro = function() {
            this.clock = new Clock(ac.sampleRate, this.ontick.bind(
                this));
            this.syncedParts = [];
            this.bpm = 120;
        ...
        p5.Metro.prototype.setBPM = function(bpm, rampTime) {
            ...
            tatumTime = beatTime;
            var ramp = rampTime || 0;
            this.clock.setRate(beatTime, rampTime + p5sound.audiocontext
                .currentTime);
            this.bpm = bpm;
        };
    ...
    src_app = function() {
        ...
        var p5SOUND = sndcore;
        return p5SOUND;
    }(sndcore, master, helpers, panner, soundfile, amplitude, fft,
        signal, oscillator, env, pulse, noise, audioin, filter,
        delay, reverb, metro, looper, soundRecorder, peakdetect,
        gain);
}));
